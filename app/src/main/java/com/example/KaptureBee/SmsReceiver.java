...
import static com.example.KaptureBee.SmsDisplayActivity.NotificationActivity;
...
public class SmsReceiver extends BroadcastReceiver {
    ...
    public String urls = "http://10.0.2.2:5000/api/v1/message/detect"; // 3.x.x.x:8000 로 변경하기
    public String s;
